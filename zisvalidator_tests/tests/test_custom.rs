...
lazy_static! {
    ...
    static ref VALIDATE_STRUCT_TUPLE_SUCC: ValidateStructTupleSucc =
        ValidateStructTupleSucc("validate".to_owned());
    static ref VALIDATE_STRUCT_TUPLE_FAIL: ValidateStructTupleFail =
        ValidateStructTupleFail("validate".to_owned());
    static ref VALIDATE_ENUM_NEWTYPE_FAIL: ValidateEnumFail =
        ValidateEnumFail::NewType("validate".to_owned());
    static ref VALIDATE_ENUM_NEWTYPE_SUCC: ValidateEnumSucc =
        ValidateEnumSucc::NewType("validate".to_owned());
    static ref VALIDATE_ENUM_TUPLE_FAIL: ValidateEnumFail =
        ValidateEnumFail::Tuple("validate".to_owned(), "validate".to_owned());
    static ref VALIDATE_ENUM_TUPLE_SUCC: ValidateEnumSucc =
        ValidateEnumSucc::Tuple("validate".to_owned(), "validate".to_owned());
    static ref VALIDATE_ENUM_FIELDS_FAIL: ValidateEnumFail = ValidateEnumFail::Fields {
        s: "validate".to_owned()
    };
    static ref VALIDATE_ENUM_FIELDS_SUCC: ValidateEnumSucc = ValidateEnumSucc::Fields {
        s: "validate".to_owned()
    };
}
    ...
    pub mod test_struct {
        ...
        fn test_struct_field() {
            assert_eq!(
                ...
                ValidatorResult::Err(VALIDATE_FAILED.clone())
            );
