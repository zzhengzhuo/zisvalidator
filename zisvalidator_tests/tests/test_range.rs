...
lazy_static! {
    static ref VALIDATE_STRUCT_SUCC: ValidateStruct = ValidateStruct { n: 3 };
    static ref VALIDATE_STRUCT_FAIL: ValidateStruct = ValidateStruct { n: 1 };
    ...
    mod test_struct {
        ...
        fn test_struct_field() {
            assert_eq!(
                ...
                ValidatorResult::Err(validator_error("n", "range", 2..))
            );
